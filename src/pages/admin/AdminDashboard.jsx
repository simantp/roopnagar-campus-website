...
export default function AdminDashboard() {
  const [isAuthenticated, setIsAuthenticated] = useState(() => sessionStorage.getItem('rns_admin_auth') === 'true');
  const { 
  ...
  const handleLogout = () => {
    sessionStorage.removeItem('rns_admin_auth');
  ...
  // Protect Admin CMS with Authentication System
  if (!isAuthenticated) {
