...
export default function ChairmanMessage() {
  const { chairmanMessage } = useCampus();
  const msg = chairmanMessage || {};
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', color: '#0f172a', paddingBottom: '90px' }}>
      ...
      <div className="rns-banner">
        <h1 className="rns-banner-title">Welcome Address</h1>
        <div className="rns-banner-breadcrumb">
          Home / Academics / <span>Chairman</span>
        </div>
      </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                borderRadius: '50%',
                overflow: 'hidden',
                background: 'linear-gradient(135deg, #a16207 0%, #334155 100%)',
                color: '#ffffff',
                fontWeight: 900,
                fontSize: '42px',
                display: 'flex',
