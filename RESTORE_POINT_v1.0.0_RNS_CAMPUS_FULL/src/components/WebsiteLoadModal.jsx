    ...
    >
      <div 
        ...
        style={{
          ...
          borderRadius: '24px',
          maxWidth: showImage && showText ? '580px' : '480px',
          width: '100%',
          maxHeight: '90vh',
          overflowY: 'auto',
          position: 'relative',
      ...
      >
        ...
        {/* 1. IMAGE BANNER */}
        {showImage && (
          <div style={{ position: 'relative', width: '100%', maxHeight: '340px', overflow: 'hidden', borderTopLeftRadius: '24px', borderTopRightRadius: '24px', backgroundColor: '#091b36' }}>
            <img 
