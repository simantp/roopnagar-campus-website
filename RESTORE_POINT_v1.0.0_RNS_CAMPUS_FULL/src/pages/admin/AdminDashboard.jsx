...
export default function AdminDashboard() {
  const { 
    ...
    updateAcademicsContents, updateChairmanMessage, updateChiefMessage, updateBoardOfDirectors, updateEvents, updateNotices, updateChronicles 
  } = useCampus();
  ...
  const handleDeleteBbsYear = (idx) => {
    if (window.confirm('Are you sure you want to remove this curriculum module?')) {
  ...
  // Helper for auto slug generation & excerpt derivation
  ...
  const handleDeleteNotice = async (idx) => {
    if (window.confirm('Are you sure you want to delete this campus notice?')) {
  ...
  const handleAddNoticeImages = async (e) => {
    ...
    try {
      ...
      const resizedImages = await Promise.all(
        files.map(file => resizeImage(file, 900, 1200, 0.85))
      );
  ...
  const handleDeleteChronicle = async (idx) => {
    if (window.confirm('Are you sure you want to delete this campus chronicle article?')) {
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <img src="/rns_logo.png" alt="RNS Logo" style={{ width: '38px', height: '38px', objectFit: 'contain' }} />
            <div>
              <div style={{ fontSize: '15px', fontWeight: 900, color: '#ffffff', leading: 1 }}>RNS Admin CMS</div>
              <div style={{ fontSize: '10px', color: '#eab308', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', display: 'flex', alignItems: 'center', gap: '4px' }}>
        ...
        <nav style={{ padding: '20px 12px', display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 }}>
          ...
          >
            <HomeIcon size={16} /> Homepage Contents (/)
          </button>
          ...
          >
            <GraduationCap size={16} /> Academics (/academics)
          </button>
          ...
          >
            <Calendar size={16} /> Campus Events (/events)
          </button>
          ...
          >
            <Bell size={16} /> Campus Notices (/notices)
          </button>
          ...
          >
            <BookOpen size={16} /> Campus Chronicles (/chronicles)
          </button>
          ...
          >
            <Sparkles size={16} /> Website Load Popup Modal
          </button>
          ...
          >
            <Settings size={16} /> General Settings & PDF Files
          </button>
        ...
        {activeTab === 'about' && (
          <form onSubmit={saveAllContentsToDatabase} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            <div style={{ backgroundColor: '#ffffff', padding: '32px', borderRadius: '20px', border: '1px solid #e2e8f0' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase', marginBottom: '4px', display: 'block' }}>Institutional Vision</label>
                  <textarea rows={3} value={aboutContents.vision} onChange={e => setAboutContents({...aboutContents, vision: e.target.value})} className="rns-search-input" style={{ borderRadius: '8px', padding: '10px 14px', width: '100%', height: 'auto' }}></textarea>
                </div>

                <div>
                  <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase', marginBottom: '4px', display: 'block' }}>Institutional Mission</label>
                  <textarea rows={3} value={aboutContents.mission} onChange={e => setAboutContents({...aboutContents, mission: e.target.value})} className="rns-search-input" style={{ borderRadius: '8px', padding: '10px 14px', width: '100%', height: 'auto' }}></textarea>
                </div>

                <div>
                  <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase', marginBottom: '4px', display: 'block' }}>Institutional Goals</label>
                  <textarea rows={3} value={aboutContents.goals} onChange={e => setAboutContents({...aboutContents, goals: e.target.value})} className="rns-search-input" style={{ borderRadius: '8px', padding: '10px 14px', width: '100%', height: 'auto' }}></textarea>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={saveAllContentsToDatabase} style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                  ...
                  <div style={{ backgroundColor: '#f8fafc', padding: '20px', borderRadius: '14px', border: '1px solid #e2e8f0' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap' }}>
                      {popupContents.imageUrl && (
                        <div style={{ width: '160px', height: '100px', borderRadius: '10px', overflow: 'hidden', border: '2px solid #cbd5e1', backgroundColor: '#091b36' }}>
                          <img src={popupContents.imageUrl} alt="Popup Preview" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        </div>
                      )}
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label className="rns-btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', cursor: 'pointer', fontSize: '12px', padding: '10px 18px' }}>
            ...
            <div style={{ backgroundColor: '#ffffff', padding: '32px', borderRadius: '20px', border: '1px solid #e2e8f0' }}>
              ...
              <div style={{ backgroundColor: '#f8fafc', padding: '24px', borderRadius: '16px', border: '1px dashed #cbd5e1', display: 'flex', justifyContent: 'center' }}>
                <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', width: '100%', maxWidth: '420px', overflow: 'hidden', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', border: '1px solid #e2e8f0' }}>
                  
                  {(popupContents.contentType === 'both' || popupContents.contentType === 'image') && popupContents.imageUrl && (
                    <div style={{ height: '180px', overflow: 'hidden', backgroundColor: '#091b36' }}>
                      <img src={popupContents.imageUrl} alt="Preview" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                  )}
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase', marginBottom: '4px', display: 'block' }}>Full Event Body Narrative & Content</label>
                <textarea 
                  rows={6} 
                  placeholder="Detailed event narrative body... (Card preview summary will be automatically generated from this content!)" 
                  value={eventFormData.content} 
                  onChange={e => setEventFormData(prev => ({ ...prev, content: e.target.value }))} 
                  className="rns-search-input" 
                  style={{ borderRadius: '8px', padding: '12px 14px', width: '100%', height: 'auto', fontSize: '13px', lineHeight: 1.6 }}
                ></textarea>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase', marginBottom: '4px', display: 'block' }}>Full Notice Body & Narrative</label>
                <textarea 
                  rows={6} 
                  placeholder="Detailed official notice content... (Card summary preview will be derived automatically from this text!)" 
                ...
                {noticeFormData.images.length > 0 ? (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '16px', marginTop: '8px' }}>
                    {noticeFormData.images.map((imgUrl, imgIdx) => (
                      ...
                      >
                        <div style={{ height: '110px', overflow: 'hidden', backgroundColor: '#091b36', position: 'relative' }}>
                          <img src={imgUrl} alt={`Attachment ${imgIdx + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        </div>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                  <label style={{ fontSize: '11px', fontWeight: 800, color: '#334155', textTransform: 'uppercase' }}>
                    Full Article Body & Narrative (Rich Text / HTML Editor)
                  </label>
                  <span style={{ fontSize: '11px', color: '#64748b' }}>
                ...
                {/* Formatting Toolbar */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '8px 12px', backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1', borderBottom: 'none', borderRadius: '12px 12px 0 0', flexWrap: 'wrap' }}>
                  <button
                    type="button"
                    onClick={() => insertFormattingTag('<b>', '</b>')}
                    style={{ fontWeight: 900, padding: '4px 10px', borderRadius: '4px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', cursor: 'pointer', fontSize: '12px' }}
                    title="Bold"
                  >
                    B
                  </button>
                  <button
                    type="button"
                    onClick={() => insertFormattingTag('<i>', '</i>')}
                    style={{ fontStyle: 'italic', fontWeight: 700, padding: '4px 10px', borderRadius: '4px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', cursor: 'pointer', fontSize: '12px' }}
                    title="Italic"
                  >
                    I
                  </button>
                  <button
                    type="button"
                    onClick={() => insertFormattingTag('<u>', '</u>')}
                    style={{ textDecoration: 'underline', fontWeight: 700, padding: '4px 10px', borderRadius: '4px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', cursor: 'pointer', fontSize: '12px' }}
                    title="Underline"
                  >
                    U
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => insertFormattingTag('<h2>', '</h2>')}
                    style={{ fontWeight: 800, padding: '4px 10px', borderRadius: '4px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', cursor: 'pointer', fontSize: '11px' }}
                  >
                    H2 Heading
                  </button>
                  <button
                  ...
                  <button
                    ...
                    style={{ fontWeight: 700, padding: '4px 10px', borderRadius: '4px', border: '1px solid #cbd5e1', backgroundColor: '#ffffff', cursor: 'pointer', fontSize: '11px' }}
                    title="Bullet List"
                  >
                    • Bullet List
                  </button>
                ...
                <textarea
                  id="chronicle-content-body-textarea"
                  rows={10}
                  placeholder="Write full article body text... (Click formatting buttons above to insert HTML tags!)"
                  value={chronicleFormData.content}
                  onChange={e => setChronicleFormData(prev => ({ ...prev, content: e.target.value }))}
                  className="rns-search-input"
                  style={{ borderRadius: '0 0 12px 12px', padding: '14px', width: '100%', height: 'auto', fontSize: '13px', lineHeight: 1.6, fontFamily: 'inherit' }}
                ></textarea>
                <div style={{ fontSize: '11px', color: '#64748b', marginTop: '4px', fontStyle: 'italic' }}>
                  ℹ️ Click any toolbar formatting button above to wrap selected text or insert formatting tags into the body.
                </div>
              </div>
